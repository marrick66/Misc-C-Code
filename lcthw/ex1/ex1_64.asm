...
//For 64 bit programs, registers are now 64 bits long, and are named
//rax, rbx, rcx, etc.  For 32 bit numbers, you can use the old eax, ebx, etc
//names.
...
//It's using the x64 calling convention, I'm assuming there are 32 and 64 bit object files out there for stdio.
000000000040052d <main>:
  ...
  40053c:	c7 45 fc 1e 00 00 00 	mov    DWORD PTR [rbp-0x4],0x1e
  400543:	8b 45 fc             	mov    eax,DWORD PTR [rbp-0x4]
  400546:	89 c6                	mov    esi,eax
  400548:	bf e4 05 40 00       	mov    edi,0x4005e4
  40054d:	b8 00 00 00 00       	mov    eax,0x0
  400552:	e8 b9 fe ff ff       	call   400410 <printf@plt>
