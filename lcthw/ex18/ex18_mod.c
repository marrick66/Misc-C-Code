...
int main(int argc, char *argv[])
{
	...
	//Break it by casting the test_sorting function to 
	//a compare_cb pointer. At this point, it's assuming that 
	//the numbers, count, and compare_cb arguments are on the stack,
	//when in fact, they aren't.
	test_sorting(numbers, count, (compare_cb)test_sorting);
