...
000000000040052d <main>:
  ...
  400543:	eb 18                	jmp    40055d <main+0x30>
  400545:	8b 45 fc             	mov    eax,DWORD PTR [rbp-0x4]
  400548:	89 c6                	mov    esi,eax
  40054a:	bf f4 05 40 00       	mov    edi,0x4005f4
  40054f:	b8 00 00 00 00       	mov    eax,0x0
  400554:	e8 b7 fe ff ff       	call   400410 <printf@plt>
  400559:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
  40055d:	83 7d fc 0e          	cmp    DWORD PTR [rbp-0x4],0xe
  400561:	7e e2                	jle    400545 <main+0x18>
