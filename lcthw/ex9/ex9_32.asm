...
0804841d <main>:
 ...
 8048426:	c7 44 24 1c 00 00 00 	mov    DWORD PTR [esp+0x1c],0x0		#initializes i to 0
 804842d:	00 
 804842e:	eb 19                	jmp    8048449 <main+0x2c>
 8048430:	8b 44 24 1c          	mov    eax,DWORD PTR [esp+0x1c]
 8048434:	89 44 24 04          	mov    DWORD PTR [esp+0x4],eax
 8048438:	c7 04 24 f0 84 04 08 	mov    DWORD PTR [esp],0x80484f0
 804843f:	e8 ac fe ff ff       	call   80482f0 <printf@plt>
 8048444:	83 44 24 1c 01       	add    DWORD PTR [esp+0x1c],0x1		#increments i
 8048449:	83 7c 24 1c 0e       	cmp    DWORD PTR [esp+0x1c],0xe		#compares i to 15, jumps back to the start
																		#to the start of the loop if i < 15
 804844e:	7e e0                	jle    8048430 <main+0x13>
