...
0000000000400440 <_start>:
  ...
  400456:	48 c7 c1 80 05 40 00 	mov    rcx,0x400580
...
000000000040052d <main>:
  ...
  40054a:	8b 45 f8             	mov    eax,DWORD PTR [rbp-0x8]
  40054d:	89 c6                	mov    esi,eax						#age is entered as first parameter to rsi as per the x64
																		#calling convention.  The fmt_attack_64.asm does not do
																		#this, so in theory, whatever 32 bit value in esi is should be printed.
  40054f:	bf 04 06 40 00       	mov    edi,0x400604
  400554:	b8 00 00 00 00       	mov    eax,0x0
  400559:	e8 b2 fe ff ff       	call   400410 <printf@plt>
  40055e:	8b 45 fc             	mov    eax,DWORD PTR [rbp-0x4]
  400561:	89 c6                	mov    esi,eax
  400563:	bf 18 06 40 00       	mov    edi,0x400618
  400568:	b8 00 00 00 00       	mov    eax,0x0
  40056d:	e8 9e fe ff ff       	call   400410 <printf@plt>
  400572:	b8 00 00 00 00       	mov    eax,0x0
  400577:	c9                   	leave  
  400578:	c3                   	ret    
...
0000000000400580 <__libc_csu_init>:
  ...
  4005ae:	e8 2d fe ff ff       	call   4003e0 <_init>
  ...
  4005e4:	c3                   	ret    
  4005e5:	66 66 2e 0f 1f 84 00 	data32 nop WORD PTR cs:[rax+rax*1+0x0]
  4005ec:	00 00 00 00 
